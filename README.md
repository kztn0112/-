...
## サイト概要
「おパン」はパン作り初心者の為の知恵袋サイトです。パン作りのコツを質問したり知っている事柄を回答することで、参加者がお互いに知識を共有してパン作りを上達することを目的としています。パンの種類と製作行程のカテゴリによって質問を検索することや、回答が役に立ったランキング形式で質問を閲覧することが出来ます。利用者はマイページから自身の質問履歴と回答履歴を確認すること出来ます。また、自身の投稿した質問に対する新規の回答がきたらログイン時に通知をします。
